...
## range
# python tools/real_query_generator.py --data data/real/dataset/india_10000.csv --query_type range --n_queries 20 --dimensions 2 --distribution uniform --skewness 1 --query_range 0.1 0.1
# python tools/real_query_generator.py --data data/real/dataset/australia_10000.csv --query_type range --n_queries 20 --dimensions 2 --distribution uniform --skewness 1 --query_range 0.1 0.1
# python tools/real_query_generator.py --data data/real/dataset/us_10000.csv --query_type range --n_queries 20 --dimensions 2 --distribution uniform --skewness 1 --query_range 0.1 0.1
