...
RLRTREE_BUILD_OUTPUT_PATH = "result/libspatialindex/rlrtree/build/{data_file_prefix}_{range_query_prefix}_{variant}_epoch_{epoch}.txt"
...
RLRTREE_KNN_QUERY_OUTPUT_PATH = "result/libspatialindex/rlrtree/knn/{data_file_prefix}_{range_query_prefix}_{knn_query_prefix}_k_{k}_{variant}_epoch_{epoch}.txt"
...
CHOOSE_SUBTREE_MODEL_NAME_DEFAULT = "benchmark/model/choose_subtree_{data_file_prefix}_{range_query_prefix}_{variant}_epoch_{epoch}.pth"
