...
class SplitLearner:
    ...
    def TimeAndSize(self):
        self.network.load_state_dict(torch.load(str(self.config.data_distribution)+'_'+'k'+str(self.config.action_space)+'.pth'))
        # self.insertion_network.Q_eval.load_state_dict(torch.load(str(self.config.model_number)+'_insertion_'+str(self.config.data_distribution)+'_'+str(self.config.reference_tree_type)+'_k'+str(self.config.action_space)+'.pth'))
        if self.config.action == 'test':
            # self.network.load_state_dict(torch.load(str(self.config.data_distribution)+'_'+'k'+str(self.config.action_space)+'.pth'))
            self.insertion_network.Q_eval.load_state_dict(torch.load(str(self.config.model_number)+'_insertion_'+str(self.config.data_distribution)+'_'+str(self.config.reference_tree_type)+'_k'+str(self.config.action_space)+'.pth'))
        elif self.config.action == 'train':
            self.insertion_network.Q_eval.load_state_dict(torch.load(str(self.config.model_number)+'_insertion_'+str(self.config.data_distribution)+'_'+str(self.config.reference_tree_type)+'_k'+str(self.config.action_space)+'_modified'+'.pth'))
    ...
    def Train6(self): # RL separate partitions with and without overlaps
        ...
        torch.save(self.insertion_network.Q_eval.state_dict(), str(self.config.model_number)+'_insertion_'+str(self.config.data_distribution)+'_'+str(self.config.reference_tree_type)+'_k'+str(self.config.action_space)+'_modified'+'.pth')
        self.tree.Clear()
        self.reference_tree.Clear()
