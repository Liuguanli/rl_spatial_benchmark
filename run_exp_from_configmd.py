...
def execute_range_query(data_file, query_file, range_query_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
    ...
    if RUN_EXHAUSTIVE_SEARCH:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} intersection {BUFFER} > {INDEX_PATH}/res {dimensions}"
    else:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} intersection {BUFFER} {dimensions}"
...
def execute_spatial_join(data_file, query_file, spatial_join_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
    ...
    if RUN_EXHAUSTIVE_SEARCH:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} selfjoin {BUFFER} > {INDEX_PATH}/res {dimensions}"
    else:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} selfjoin {BUFFER} {dimensions}"
...
def execute_knn_query(k, query_file, data_file, knn_query_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
    ...
    if RUN_EXHAUSTIVE_SEARCH:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} {k}NN {BUFFER}> res {dimensions}"
    else:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} {k}NN {BUFFER} {dimensions}"
...
def execute_point_query(query_file, data_file, point_query_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
    ...
    if RUN_EXHAUSTIVE_SEARCH:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} intersection {BUFFER} > res {dimensions}"
    else:
        command = f"{test_file} {query_file} {INDEX_PATH}/{index_name} intersection {BUFFER} {dimensions}"
...
def execute_insert(query_file, insert_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
...
def execute_insert_point(query_file, insert_point_output_path, test_file="test-rtree-RTreeQuerymd", index_name="tree", dimensions=3):
...
def run_zorder(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        if not os.path.exists(z_order_output_default):
            ...
            transform_command = f"python tools/zorder_md.py {ablosute_data_file_name} {Z_ORDER_OUTPUT} --dim {data_dimensions} --bits {bit_num}"
            elapsed_time_ns_order = execute_command(transform_command)

            format_data_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --input {Z_ORDER_OUTPUT} --output {data_file}"
        ...
        command = f"test-rtree-SFCRTreeBulkLoadmd {data_file} {INDEX_PATH}/zorder {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        ...
        for file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
        ...
        for file_name in spatial_joins:
            ...
            query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, file_name_prefix)
            execute_spatial_join(data_file, query_file, join_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
        ...
        for file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, query_file, data_file, knn_query_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, "test-rtree-RTreeQuerymd", index_name="zorder", dimensions=data_dimensions)
...
def run_zm(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        if not os.path.exists(z_order_output_default):
            ...
            format_data_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --input {RANK_SPACE_Z_ORDER_OUTPUT} --output {data_file} --is_learned True"
        ...
        command = f"test-learnedindex-ZMBulkLoadmd {data_file} {INDEX_PATH}/zm {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        result, elapsed_time_ns_build = execute_command_with_err(command)
        ...
        for range_file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
        ...
        for join_file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
        ...
        for knn_file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, test_file="test-learnedindex-ZMQuerymd", index_name="zm", dimensions=data_dimensions)
...
def run_lisa(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        data_file = LISA_DATA
        format_data_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --input {ablosute_data_file_name} --output {data_file}"
        execute_command(format_data_command)

        logger.info(f"Start building lisa: {data_file}")

        build_output_path = LISA_BUILD_OUTPUT_PATH.format(
                        data_file_prefix=data_file_prefix
                    )

        command = f"test-learnedindex-LISABulkLoadmd {data_file} {INDEX_PATH}/lisa {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        result, elapsed_time_ns_build = execute_command_with_err(command)
        ...
        with open(build_output_path, "w") as f:
            if result:
                f.write(result.stderr)
            f.write(f"Elapsed Build Time: {elapsed_time_ns_build}\n")
            f.write(f"Tree.dat Size: {os.path.getsize(f'{INDEX_PATH}/lisa.dat')}\n")
            f.write(f"Tree.idx Size: {os.path.getsize(f'{INDEX_PATH}/lisa.idx')}\n")

        for range_file_name in range_queries:
            file_name_prefix = range_file_name.rstrip('.csv')
            query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, file_name_prefix)
            range_query_output_path = LISA_RANGE_QUERY_OUTPUT_PATH.format(
                data_file_prefix=data_file_prefix,
                range_query_prefix=file_name_prefix
            )
            execute_range_query(data_file, query_file, range_query_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)
        ...
        for join_file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)
        ...
        for knn_file_name in knn_queries:
            ...
            ks = ks_map.get(knn_file_name)
            for k in ks:
                knn_query_output_path = LISA_KNN_QUERY_OUTPUT_PATH.format(
                    data_file_prefix=data_file_prefix,
                    knn_query_prefix=knn_file_name_prefix,
                    k=k,
                )
                execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)

        for file_name in point_queries:
            point_file_name_prefix = file_name.rstrip('.csv')
            query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, point_file_name_prefix)
            point_query_output_path = LISA_POINT_QUERY_OUTPUT_PATH.format(
                data_file_prefix=data_file_prefix,
                point_query_prefix=point_file_name_prefix
            )
            execute_point_query(query_file, data_file, point_query_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)

        for file_name in insertions:
            file_name_prefix = file_name.rstrip('.csv')
            query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, file_name_prefix)
            insert_output_path = LISA_INSERT_OUTPUT_PATH.format(
                data_file_prefix=data_file_prefix,
                insert_prefix=file_name_prefix
            )
            execute_insert(query_file, insert_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)

        for file_name in insert_points:
            file_name_prefix = file_name.rstrip('.csv')
            query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, file_name_prefix)
            insert_point_output_path = LISA_INSERT_POINT_OUTPUT_PATH.format(
                data_file_prefix=data_file_prefix,
                insert_point_prefix=file_name_prefix
            )
            execute_insert_point(query_file, insert_point_output_path, test_file="test-learnedindex-LISAQuerymd", index_name="lisa", dimensions=data_dimensions)
...
def run_rankspace(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        if not os.path.exists(rank_space_z_order_output_default):
            ...
            format_data_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --input {RANK_SPACE_Z_ORDER_OUTPUT} --output {data_file}"
            execute_command(format_data_command)
        ...
        command = f"test-rtree-SFCRTreeBulkLoadmd {data_file} {INDEX_PATH}/rankspace {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        ...
        for file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="rankspace", dimensions=data_dimensions)
        ...
        for file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, index_name="rankspace", dimensions=data_dimensions)
        ...
        for file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, query_file, data_file, knn_query_output_path, index_name="rankspace", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, index_name="rankspace", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, index_name="rankspace", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, index_name="rankspace", dimensions=data_dimensions)
...
def run_bmtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            learn_bmtree_command = f"bash rl_baseline/learn_bmtree.sh {data_file_prefix} {file_name_prefix} {tree_depth} {sample_size} {bit_num} {ablosute_data_file_name} {is_train} {0} {data_dimensions}"
            elapsed_time_ns_learn = execute_command(learn_bmtree_command)

            data_adapter_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --is_scaled --input {BMTREE_INPUT} --output {BMTREE_OUTPUT}"
            ...
            command = f"test-rtree-SFCRTreeBulkLoadmd {BMTREE_OUTPUT} {INDEX_PATH}/bmtree {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
            result, elapsed_time_ns_build = execute_command_with_err(command)
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="bmtree", dimensions=data_dimensions)
            ...
            for knn_file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, index_name="bmtree", dimensions=data_dimensions)
            ...
            for spatial_join_file_name in spatial_joins:
                ...
                execute_spatial_join(data_file, query_file, join_output_path, index_name="bmtree", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, index_name="bmtree", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, index_name="bmtree", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, index_name="bmtree", dimensions=data_dimensions)
...
def run_bmtree_impr(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            cost_method = 1
            learn_bmtree_command = f"bash rl_baseline/learn_bmtree.sh {data_file_prefix} {file_name_prefix} {tree_depth} {sample_size} {bit_num} {ablosute_data_file_name} {is_train} {cost_method} {data_dimensions}"
            elapsed_time_ns_learn = execute_command(learn_bmtree_command)

            data_adapter_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --is_scaled --input {BMTREEIMPR_INPUT} --output {BMTREEIMPR_OUTPUT}"
            execute_command(data_adapter_command)
            ...
            # build bmtree sfcrtree
            command = f"test-rtree-SFCRTreeBulkLoadmd {BMTREEIMPR_OUTPUT} {INDEX_PATH}/bmtree_impr {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
            result, elapsed_time_ns_build = execute_command_with_err(command)
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
            ...
            for knn_file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
            ...
            for spatial_join_file_name in spatial_joins:
                ...
                query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, spatial_join_file_name_prefix)
                execute_spatial_join(data_file, query_file, join_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, index_name="bmtree_impr", dimensions=data_dimensions)
...
def run_rtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        command = f"test-rtree-RTreeLoadmd {data_file} {INDEX_PATH}/rtree {page_size} {fill_factor} {rtree_variant} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        ...
        for file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="rtree", dimensions=data_dimensions)
        ...
        for file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, index_name="rtree", dimensions=data_dimensions)
        ...
        for file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, query_file, data_file, knn_query_output_path, index_name="rtree", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, index_name="rtree", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, index_name="rtree", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, index_name="rtree", dimensions=data_dimensions)
...
def run_rstartree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        command = f"test-rtree-RTreeLoadmd {data_file} {INDEX_PATH}/rstar {page_size} {fill_factor} {rtree_variant} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
        ...
        for file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="rstar", dimensions=data_dimensions)
        ...
        for file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, index_name="rstar", dimensions=data_dimensions)
        ...
        for file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, query_file, data_file, knn_query_output_path, index_name="rstar", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, index_name="rstar", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, index_name="rstar", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, index_name="rstar", dimensions=data_dimensions)
...
def run_rlrtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            command = f"test-rtree-RTreeLoadmd {data_file} {INDEX_PATH}/rlrtree {page_size} {fill_factor} {rtree_variant} {model_path} {BLOCK_SIZE} {BUFFER} {data_dimensions}"
            result, elapsed_time_ns_build = execute_command_with_err(command)
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="rlrtree", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, index_name="rlrtree", dimensions=data_dimensions)

            for file_name in spatial_joins:
                join_file_name_prefix = file_name.rstrip('.csv')
                query_file = os.path.join(BENCHMARK_LIBSPATIALINDEX, point_file_name_prefix)
                join_query_output_path = RLRTREE_JOIN_QUERY_OUTPUT_PATH.format(
                    data_file_prefix=data_file_prefix,
                    range_query_prefix=file_name_prefix,
                ...
                execute_spatial_join(query_file, data_file, join_query_output_path, index_name="rlrtree", dimensions=data_dimensions)
            ...
            for file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, index_name="rlrtree", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, index_name="rlrtree", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, index_name="rlrtree", dimensions=data_dimensions)
...
def run_kdtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        command = f"test-kdtree-KDTreeBulkLoadmd kdtree {data_file} path {INDEX_PATH}/kdtree {page_size} 1.0 {BLOCK_SIZE} {BUFFER} {data_dimensions}"  
        ...
        for file_name in range_queries:
            ...
            execute_range_query(data_file, query_file, range_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
        ...
        for file_name in spatial_joins:
            ...
            execute_spatial_join(data_file, query_file, join_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
        ...
        for file_name in knn_queries:
            ...
            for k in ks:
                ...
                execute_knn_query(k, query_file, data_file, knn_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
        ...
        for file_name in point_queries:
            ...
            execute_point_query(query_file, data_file, point_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
        ...
        for file_name in insertions:
            ...
            execute_insert(query_file, insert_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
        ...
        for file_name in insert_points:
            ...
            execute_insert_point(query_file, insert_point_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdtree", dimensions=data_dimensions)
...
def run_kdtree_greedy(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            command = f"test-kdtree-KDTreeBulkLoadmd greedy_kdtree {data_file} {query_file} {INDEX_PATH}/kdgreedy {page_size} 1.0 {BLOCK_SIZE} {BUFFER} {data_dimensions}"  
            ...
            execute_range_query(data_file, query_file, range_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
            ...
            for file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, query_file, data_file, knn_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
            ...
            for file_name in spatial_joins:
                ...
                execute_spatial_join(query_file, data_file, join_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, "test-kdtree-KDTreeQuerymd", index_name="kdgreedy", dimensions=data_dimensions)
...
def run_qdtree_rl(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            if not os.path.exists(qdtree_model_name_default):
                ...
                learn_qdtree_command = f"bash rl_baseline/learn_qdtree.sh {ablosute_data_file_name} {ablosute_query_file_name} {episode} {sampling_ratio} {action_sampling_size} {data_dimensions}"
            ...
            command = f"test-kdtree-QDTreeBulkLoadmd qdtree {data_file} {query_file} {INDEX_PATH}/qdtree {page_size} 1.0 {model_path} {action_sampling_size} {BLOCK_SIZE} {BUFFER} {data_dimensions}"  
            ...
            execute_range_query(data_file, query_file, range_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
            ...
            for file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, query_file, data_file, knn_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
            ...
            for file_name in spatial_joins:
                ...
                execute_spatial_join(query_file, data_file, join_query_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, "test-kdtree-KDTreeQuerymd", index_name="qdtree", dimensions=data_dimensions)
...
def run_platon(data_file_name, query_maps, ks_map, baseline_config, data_dimensions):
    ...
    try:
        ...
        for range_file_name in range_queries:
            ...
            data_adapter_command = f"python tools/libspatialindex_data_adapter.py --type data --dimensions {data_dimensions} --input {ablosute_data_file_name} --output {PLATON_DATA}"
            execute_command(data_adapter_command)

            # command = f"test-rtree-PlatonBulkLoad {PLATON_DATA} {INDEX_PATH}/platon {page_size} {fill_factor} {BLOCK_SIZE} {BUFFER}"
            command = f"test-rtree-PlatonBulkLoadmd {PLATON_DATA} {INDEX_PATH}/platon {page_size} {fill_factor} tgs {platon_output_default} {data_dimensions}"
            result, elapsed_time_ns_build = execute_command_with_err(command)
            ...
            execute_range_query(data_file, query_file, range_query_output_path, index_name="platon", dimensions=data_dimensions)
            ...
            for knn_file_name in knn_queries:
                ...
                for k in ks:
                    ...
                    execute_knn_query(k, knn_query_file, data_file, knn_query_output_path, index_name="platon", dimensions=data_dimensions)
            ...
            for file_name in point_queries:
                ...
                execute_point_query(query_file, data_file, point_query_output_path, index_name="platon", dimensions=data_dimensions)
            ...
            for file_name in spatial_joins:
                ...
                execute_spatial_join(query_file, data_file, join_query_output_path, index_name="platon", dimensions=data_dimensions)
            ...
            for file_name in insertions:
                ...
                execute_insert(query_file, insert_output_path, index_name="platon", dimensions=data_dimensions)
            ...
            for file_name in insert_points:
                ...
                execute_insert_point(query_file, insert_point_output_path, index_name="platon", dimensions=data_dimensions)
...
def process_experiment(experiment):
    ...
    if data_distribution in ["uniform", "normal", "skewed"]:
        ...
        data_file_name = RELATIVE_REAL_DATA_FILENAME_MD.format(
        ...
        if len(range_queries) == 0:
            ...
            if not os.path.exists(os.path.join(REAL_QUERY_PATH, REAL_RANGE_QUERY_FILENAME_DEFAULT.format(data=base_name))):
                query_command = f"python tools/real_query_generator.py --data {absolute_data_file_name} --query_type range --n_queries 1000 --dimensions {data_dimensions} --distribution uniform --skewness 1 --query_range 0.001 0.001"
                execute_command(query_command)
            is_range_query = False
    ...
    for query_type, file_names in query_maps.items():
        for file_name in file_names:
            ...
            if os.path.exists(os.path.join(BENCHMARK_LIBSPATIALINDEX, file_name_prefix)):
                ...
                format_query_command = f"python tools/libspatialindex_data_adapter.py --type {query_type} --dimensions {data_dimensions} --input {file_name} --output {BENCHMARK_LIBSPATIALINDEX}/{file_name_prefix}"
    ...
    for baseline in experiment['baseline']:
        ...
        if baseline_name == "zorder":
            run_zorder(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "bmtree":
            run_bmtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "rankspace":
            run_rankspace(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "rtree":
            run_rtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "rstar":
            run_rstartree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "rlrtree":
            run_rlrtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "kdtree":
            run_kdtree(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "kdgreedy":
            run_kdtree_greedy(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "qdtree":
            run_qdtree_rl(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "platon":
            run_platon(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "zm":
            run_zm(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "lisa":
            run_lisa(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
        elif baseline_name == "bmtree_impr":
            run_bmtree_impr(data_file_name, query_maps, ks_map, baseline_config, data_dimensions)
...
# test-learnedindex-LISAQuery benchmark/libspatialindex/us_10000000_range_1000_2_uniform_1_0.001x0.001 /media/liuguanli/DATA/lisa intersection 0