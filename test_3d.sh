...
# python run_exp_from_config3d.py exp_config/3d/test_rstar.json
# python run_exp_from_config3d.py exp_config/3d/test_rlrtree.json
# python run_exp_from_config3d.py exp_config/3d/test_rankspace.json
# python run_exp_from_config3d.py exp_config/3d/test_qdtree.json
# python run_exp_from_config3d.py exp_config/3d/test_kdgreedy.json
# python run_exp_from_config3d.py exp_config/3d/test_zm.json
